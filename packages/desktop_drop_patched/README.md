...
This vendored LinPlayer copy intentionally omits Android plugin registration.
The app only uses drag-and-drop on desktop/web, so excluding Android keeps
Flutter plugin registration stable across dependency updates.
