...
class _ExoPlayerScreenState extends State<ExoPlayerScreen>
  ...
  void _primeMobileTrackPanel(_MobilePlayerPanel panel) {
    switch (panel) {
  ...
  Future<void> _onExoLocalPlaybackEnded() async {
      ...
      _uiTimer = Timer.periodic(const Duration(milliseconds: 250), (_) {
        ...
        if (_duration > Duration.zero &&
          ...
          if (!_mobilePlaybackEndHandled) {
            ...
            unawaited(_onExoLocalPlaybackEnded());
          }
        }
